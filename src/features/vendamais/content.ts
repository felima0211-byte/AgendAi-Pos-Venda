...
export const ESTUDOS: EstudoDoDia[] = [
  {
    ...
    bullets: [
      ...
      'Vendedoras que registram o atendimento no mesmo dia têm um histórico 87% mais completo em 6 meses',
    ],
    destaque: 'Não espere o cliente sumir para entrar em contato. O momento ideal é entre 2 e 4 dias após a compra.',
  },
  {
    titulo: 'Ticket médio: como aumentar sem dar desconto',
    subtitulo: 'Estratégias de upsell e cross-sell que funcionam na prática',
    fonte: 'Sebrae — Relatório de Tendências do Varejo, 2025',
    bullets: [
      ...
      'Conhecer o histórico da cliente e o que ela já comprou é um diferencial que nenhuma plataforma entrega',
  ...
  },
  {
    ...
    subtitulo: 'Dados reais de conversão no maior canal de relacionamento do Brasil',
    ...
    bullets: [
      ...
      'Fotos reais do produto, do processo ou do uso convertem mais do que imagens de catálogo padrão',
  ...
  },
  {
    ...
    subtitulo: 'O que funciona para vendedoras em 2026',
    ...
    bullets: [
      ...
      'Depoimento em vídeo de cliente real vale 10x mais do que qualquer anúncio pago',
  ...
  {
    titulo: 'Como comunicar valor sem depender de desconto',
    subtitulo: 'Precificação e posicionamento para vendedoras de todos os canais',
    fonte: 'Sebrae — Finanças e Estratégia para Vendas, 2025',
    bullets: [
      'Cobrar pelo valor percebido, não só pelo custo + margem, é o que distingue vendedoras de alta performance',
      'Cliente que pechincha muito não é necessariamente o mais lucrativo — qualidade de relacionamento vale mais que volume',
      'Aumento de preço bem comunicado com antecedência perde menos clientes do que aumento surpresa',
      'Benefícios tangíveis (entrega rápida, embalagem cuidada, atendimento ágil) justificam preço sem precisar explicar',
      'Transparência sobre o que está incluso no valor gera mais confiança do que qualquer promoção',
    ],
    destaque: 'Preço baixo não fideliza. Relação e qualidade fidelizam — e abrem espaço para cobrar mais.',
  },
  {
    titulo: 'Como manter ritmo e bem-estar nas vendas',
    subtitulo: 'Produtividade sem abrir mão da qualidade de vida',
    fonte: 'IPEA — Trabalho e Bem-Estar de Profissionais de Vendas, 2025',
    bullets: [
      '73% das vendedoras relatam sobrecarga por falta de rotina estruturada — independente do canal',
      'Separar horários fixos de atendimento e horários de pausa aumenta a produtividade em 28%',
      'Registrar o histórico de atendimentos economiza em média 45 min/dia de memória ativa',
      'Celebrar metas pequenas (não só anuais) mantém a motivação constante ao longo do mês',
      'Ter uma rede de apoio entre colegas de trabalho é o fator mais citado de longevidade na área de vendas',
    ],
    destaque: 'Resultado consistente começa com rotina sustentável. Cuide de você para atender bem.',
  },
  {
    ...
    bullets: [
      'Moda íntima e fitness cresceu 34% em volume de vendas no Brasil em 2025',
      ...
      'Beleza e cuidados pessoais é a categoria com maior taxa de recompra no varejo',
      'Personalização — produto adaptado ao gosto ou à medida — é o atributo mais valorizado em 2026',
    ],
    destaque: 'Personalização é o que transforma uma boa venda em uma experiência que o cliente recomenda.',
  },
  {
    ...
    destaque: 'Use sua voz. Ela transmite o que texto nenhum consegue — e é o que cria conexão de verdade.',
  },
  {
    ...
    bullets: [
      ...
      'Vendedora com 60% de base fidelizada tem receita 40% mais previsível e estável do que quem só capta clientes novos',
    ],
  ...
  {
    titulo: 'Controle financeiro básico para quem trabalha com vendas',
    subtitulo: 'O mínimo que toda vendedora precisa acompanhar',
    fonte: 'Sebrae — Educação Financeira no Varejo, 2026',
    bullets: [
      'Separar o que é receita da venda do que é despesa operacional é o ponto de partida do controle real',
      'Custo do produto + logística + embalagem + tempo de atendimento = custo real da venda (o tempo é o que mais esquece)',
      'Ter uma reserva equivalente a 3 meses de custos fixos protege o desempenho nos meses mais fracos',
      'Conhecer o ticket médio por cliente ajuda a prever receita e planejar estoque com mais segurança',
      'Registrar cada venda — mesmo a pequena — é a diferença entre saber se está lucrando ou não',
    ],
    destaque: 'Quem não sabe quanto lucra não tem controle, tem sorte. Começa com 5 minutos por dia.',
  },
  {
  ...
  },
  {
    ...
    subtitulo: 'Posicionamento genuíno para quem quer vender com consistência',
...
export const CASOS: CasoGrandeMarca[] = [
  ...
  },
  {
    marca: 'Avon Brasil',
    segmento: 'Beleza & Cosméticos',
    titulo: 'Como 1,5 milhão de revendedoras usam relacionamento como vantagem',
...
export const ESTATISTICAS: EstatisticaVenda[] = [
  ...
  {
    numero: '169 milhões',
    descricao: 'de usuários ativos no WhatsApp no Brasil — maior penetração per capita do mundo',
  ...
  {
    numero: '1,5 milhão',
    descricao: 'de revendedoras ativas no Brasil — o maior sistema de vendas diretas da América Latina',
